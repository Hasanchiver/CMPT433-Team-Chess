...
void drawChessPiece();
void drawChessPieceImage(int i, int j, int type);
...
#define BOARD_CELL_COLOR_1		0xD8
#define BOARD_CELL_COLOR_2		0xFE
#define BOARD_OUTER_COLOR		0xB3




#define C8_WHITE				0xFF
