...
int waitPoll(uint8_t, uint8_t);
void drawPixel(int16_t, int16_t, uint8_t);



void loadNewGameScene( void );
void loadRestartScene( void );
void loadWinScene( int winSide );



int win_touchPanelListen( void );
...
void drawChessPieceImage(int i, int j, int type, int);




void selectLayer(int);
void setLayerDisplayMode(int);
void setLayerTransparency(int, uint8_t);
...
void c8_setBackgroundColour(int, uint8_t);
void c8_drawRect(int16_t, int16_t, int16_t, int16_t, uint8_t, int);
...
void drawCircle(int16_t x0, int16_t y0, int16_t r, uint8_t color, int fill);


int gameboard_touchPanelListen( int *row, int *col );
int restart_touchPanelListen( void );
int swap_touchPanelListen( int *type );
...
void setMoveMarker(int row, int col);

void update_gameboard(uint8_t old_table[8][8], uint8_t new_table[8][8]) ;


// Colours for our application
#define BOARD_CELL_COLOR_1		0x00
#define BOARD_CELL_COLOR_2		0xFF
#define BOARD_BACKGROUND_COLOR	0x29

#define CHESS_COLOR1			0x0B
#define CHESS_COLOR2			0xD0


#define ELIGIBLE_MOVE_COLOR		0x1C
#define MOVED_COLOR				0xE0
#define TRANS_COLOR				0x0C


#define RESTART_SCENE_BACKGROUND_COLOR		0xFF
#define RESTART_SCENE_BTN_COLOR				0x00
#define RESTART_SCENE_TEXT_COLOR			0x00
